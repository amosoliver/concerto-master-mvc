class ExamplesController < ApplicationController
  ...
  def create
    ...
    if @example.save
      redirect_to @example, notice: "Exemplo criado com sucesso."
    else
  ...
  def update
    if @example.update(example_params)
      redirect_to @example, notice: "Exemplo atualizado com sucesso."
    else
  ...
  def destroy
    @example.discard
    redirect_to examples_path, notice: "Exemplo removido com sucesso."
  end
